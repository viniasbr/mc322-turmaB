...
public class Main {
    public static void main(String args [])
    {
        ...
        ClientePJ cliente2 = new ClientePJ("Firma Exemplo e CIA.", "Rua Comercial, 234", veiculo2, "81.808.861/0001-00", LocalDate.parse("10/10/2021", formatador), 100);
        ...
        cliente2.setValorSeguro(seguradora.calcularPrecoSeguroCliente(cliente2));
        String listaClientes = seguradora.listarClientes("PF") + "\n" +seguradora.listarClientes("PJ");
        ...
        System.out.print("\nClientes da seguradora exemplo:\n\n" +listaClientes+"\nSinistros da seguradora exemplo:\n" +listaSinistros+"\nAna Borges Carvalho possui um sinistro?: " +anaTemSinistros+"\n\nA receita total da seguradora do exemplo é de R$"+String.format("%.2f", receita)+". Iniciando o menu textual...\n\n");
